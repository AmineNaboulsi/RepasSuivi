  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <a href="#temoignages" className="text-gray-600 hover:text-indigo-600 transition-colors font-medium">Témoignages</a>
            </div>
      ...
      <section id="temoignages" className="py-24 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <span className="text-indigo-600 font-semibold">TÉMOIGNAGES</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-gray-900">
              Ce que disent nos utilisateurs
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez comment RepasSuivi a aidé d&apos;autres personnes à atteindre leurs objectifs nutritionnels.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md">
              ...
              <p className="text-gray-700 mb-4">
                &ldquo;Grâce à RepasSuivi, j&apos;ai perdu 5 kg en suivant les recommandations IA. L&apos;application m&apos;a aidée à mieux comprendre mon alimentation et à faire des choix plus sains.&ldquo;
              </p>
